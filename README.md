...
//I developed this this shop management system using C++
#include<iostream>    // input/output operation             
#include<fstream>     // read and write the data
#include<string>   //used for store character
#include <sstream> // used for implement the input/output ooperation
#include <bits/stdc++.h>   // linked list 
#include<windows.h>      // 
#include"queue1.h"
#include"animation.h"
#include"stackme.h"
...
class node
 {
	...
	int ID;
	string proName;
	double prePrice;  // hold floating-point no up a space of 8bytes.
	int quantity;
      node* next;
};
...
////////////////////////////////////////////////////////////////////
 void beg()
{
	system("cls");   // clear screen and go for to next page
...
int main()
{
     ...
     for(int i=0;i<=51;i++)
     {
		...
		system("color 6");     //  for console color
	gotoxy(17,5);
	cout<<"--------------------------------------------------"<<endl;
	gotoxy(17,7);
	...
	cout<<"--------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> Mam khadija javaid <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<">>>----Project Implemented By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"Sufian Kamran (215)"<<endl;
   	gotoxy(22,16);
   	cout<<"Asad Ullah  (251)"<<endl;
   	gotoxy(22,17);
   	cout<<"Anas Munir  (217)"<<endl;
   	gotoxy(22,18);
   	cout<<"AbuBakar Saad  (492)"<<endl;
   	gotoxy(22,19);
   	cout<<"Ali Asad  (267)"<<endl;
	system("pause");
	system("cls");
// 	system("color Fc"); 
